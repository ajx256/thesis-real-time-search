...
template <class D>
struct DFSKBestCsernaBackupPembertonBelief
{
	...
	DFSKBestCsernaBackupPembertonBelief(D& domain, int lookahead, int k) : domain(domain), lookahead(lookahead), k(k)
	{
		switch (lookahead)
		{
		case 3:
	...
	~DFSKBestCsernaBackupPembertonBelief()
	{
