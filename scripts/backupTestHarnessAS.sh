...
if (($# < 2))
then
  echo "./backupTestHarnessAS.sh <# of processes> <Lookahead value 1> <optional: additional lookahead values>"
  exit 1
fi
    ...
    do
      ...
      do
		...
		then 
		  ...
		  ./../backupTestsAS.sh ${lookahead} ../results/backupTests/AS/b${b}d${d}/LA${lookahead}-${instance}.json < ${file} &
		  let instance++
          let numProcs++
		fi
      done
